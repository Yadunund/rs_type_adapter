...
template<>
struct rclcpp::TypeAdapter<rs_type_adapt_example::ROSCvMatContainer, sensor_msgs::msg::Image>
{
  using is_specialized = std::true_type;
  using custom_type = rs_type_adapt_example::ROSCvMatContainer;
  ...
  {
    destination = rs_type_adapt_example::ROSCvMatContainer(source);
  }
};
