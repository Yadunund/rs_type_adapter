...
'''
Launch realsense2_camera node & a simple subscriber without type adaptation and on different processes, 
Run syntax: ros2 launch rs_type_adapter_example image_no_type_adapt_no_intra.py
'''
