...
'''
Launch realsense2_camera node & multiple simple subscribers without type adaptation and on different processes, 
Run syntax: ros2 launch rs_type_adapter_example image_multiple_no_type_adapt_no_intra.py
'''
...
def generate_launch_description():
    ...
    return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
        ...
        launch_ros.actions.Node(
            ...
            name='image_sub_no_intra_1',
            output='both'
        ),
        launch_ros.actions.Node(
            package='rs_type_adapter_example',
            executable='image_sub_intra',
            name='image_sub_no_intra_2',
            output='both'
        ),
        launch_ros.actions.Node(
            package='rs_type_adapter_example',
            executable='image_sub_intra',
            name='image_sub_no_intra_3',
            output='both'
        ),
    ])
